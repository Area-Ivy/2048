...
bool GameMenuLayer::init()
{
	...
	auto resetmenu = menuButton->getMenuItem("重新开始", Size(115, 30));
	...
	this->addChild(setBg);
	auto setmenu = menuButton->getMenuItem("排行榜", Size(40, 30));
	...
	auto undomenu = menuButton->getMenuItem("撤回", Size(60, 30));
